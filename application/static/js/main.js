var MarginaliaApp = angular.module('MarginaliaApp', ['ngRoute', 'restangular', 'LocalStorageModule'])
    ...
    .config(function ($routeProvider, RestangularProvider) {
        ...
        $routeProvider
            ...
            .when('/books', {
                ...
                templateUrl: partialsDir + 'list.html'
            })
            ...
            .when('/book/create', {
                ...
                templateUrl: partialsDir + '/book/create.html',
                resolve: {
